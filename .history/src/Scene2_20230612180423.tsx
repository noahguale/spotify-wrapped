...
const Bar: FC<BarProps> = ({color, children, endWidth}) => {
	return (
		<div
			className={`h-[150px] w-[${endWidth}px] rounded-full mt-[10px]`}
			style={{backgroundColor: color, width: endWidth}}
		>
			{children}
		</div>
	);
...
export const Scene2: FC = () => {
	...
	return (
		<AbsoluteFill className="bg-[#d4148e]">
			...
			<Bar color="#d5f772" endWidth={width / 3 - 40}>
				{' '}
				Test{' '}
			</Bar>
			<Bar color="#4e00f9" endWidth={width / 2 - 80}>
				{' '}
				Test{' '}
			</Bar>
			<Bar color="#1e1416" endWidth={width / 2 - 120}>
				{' '}
				Test{' '}
			</Bar>
			<Bar color="#fefefe" endWidth={width / 2 - 160}>
				{' '}
				Test{' '}
			</Bar>
		</AbsoluteFill>
